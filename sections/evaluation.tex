...
These optimizations make AI-driven scheduler optimization economically viable for production deployment. If the cost of design and implementation of a new scheduler is lower than the cost of instance cpu time, it is economically viable. Originally people only design special scheduler for cloud computing workloads on hundreds of machines. Now with the help of AI, we can design special scheduler for short and specific workloads like CI building and unit testing that may only run for hours or days on a single machine.
